...
# ----------------------------------------------------------------------
# 本文件持有 Stage 1 SFT 的全部超参，调用 verl 的 SFT训练入口
# (verl.trainer.sft_trainer)。train_sft.sh 仅负责设置路径环境变量后调用本文件。
#
# 运行:
# # NPROC=8 MODEL_PATH=./Qwen3-8B SFT_DATA=./data/verl/sft.parquet \
